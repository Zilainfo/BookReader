...
namespace BooksReader
{
    ...
    public sealed partial class App : PrismUnityApplication
    {
        ...
        {
            await LaunchApplicationAsync(PageTokens.BooksPage, null);
        }
        ...
        protected override async Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "BooksReader.ViewModels.{0}ViewModel, BooksReader", viewType.Name.Substring(0, viewType.Name.Length - 4));
